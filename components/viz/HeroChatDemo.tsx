    ...
    resolution: (
      <div className="p-3 rounded-lg bg-surface border border-accent-primary/20 text-xs space-y-1.5">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-mono text-accent-primary">CCTP V2</span>
        </div>
...
export default function HeroChatDemo() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full max-w-[460px] p-5 rounded-2xl bg-surface-raised/90 border border-border-strong shadow-2xl backdrop-blur-xl font-sans text-left transition-all"
    >
      {/* Header */}
      <div className="flex items-center justify-between pb-3 mb-4 border-b border-border text-xs">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-text-primary tracking-wide">Rova Agent</span>
        </div>
      ...
      <div className="min-h-[130px] flex flex-col justify-end space-y-3 mb-4">
        {(step === 'sent' || step === 'processing' || step === 'resolved' || step === 'hold') && (
          <div className="self-end max-w-[85%] px-3.5 py-2.5 rounded-2xl rounded-tr-sm bg-accent-primary/10 border border-accent-primary/20 text-xs text-text-primary font-medium shadow-sm animate-fade-up">
      ...
      {/* Input Pill */}
      <div className="flex items-center gap-2 p-2 pl-4 rounded-full bg-surface border border-border">
